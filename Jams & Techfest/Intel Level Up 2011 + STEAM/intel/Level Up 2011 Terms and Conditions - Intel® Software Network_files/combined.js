...
if(typeof(loginURL) == "undefined") {
 var loginURL = 'https://login-software.intel.com/isn/Login/Template.aspx';
}
...
if ( get_cookie("SMSESSION")!="" && get_cookie("SMIDENTITY") != ""){
    if ( get_cookie("ISNUSER")=="" || get_cookie("UserRoles")==""){
        document.location = "https://login-software.intel.com/isn/Login/LoginLite.aspx?Lang=ENG&TARGET="+encodeURIComponent(thisURL);
    }
}
...
$(function() {
 $(".freedownload").each(function(){
      ...
      $(this).attr("href","javascript:void(0);");
 	  ...
 	  {
        $(this).click(function(){
          var thisFileToDL = $(this).attr("filename").replace(" ","");
          if ( thisFileToDL.indexOf("www.intelsoftwaregraphics.com") == -1) 
             thisFileToDL = thisFileToDL.toLowerCase();
          isnDL(thisFileToDL,$(this).hasClass("emailrequired"),$(this).attr("title"));
        });
 	  }
 });
