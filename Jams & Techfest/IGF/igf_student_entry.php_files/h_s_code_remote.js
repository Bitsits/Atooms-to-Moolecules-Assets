...
function s_doPlugins(s)
{
	...
	/* Plugin: getQueryParam 2.3 set s.prop1 to q= parameter for internal search q=google search results, queryText=verity, search_text=gama, searchcontent=crn */
	s.prop1=s.getQueryParam('q,queryText,keyword,search_text,searchContent',':');
