...
function togglefreeform() {
	$('input[answer_id]').each(function(index) {
...
function init_poll_results() {
	$(document.body).prepend('<div class="jqmWindow box" style="left:50%;width:400px;height:400px;overflow:auto" id="poll_res">'+ '<div class="boxHeader"><a href="#" alt="close" class="jqmClose">' + "[X]" + '</a><strong>&nbsp;&nbsp;'+ POLL_RESULTS + '</strong></div>'
